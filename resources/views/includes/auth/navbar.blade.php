<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            {{--  <button type="button" class="btn btn-sm px-3 font-size-16 header-item" id="vertical-menu-btn" disabled>
        ...
        <div class="d-flex d-none d-md-block">
            <div class="">
                <span class="logo">
                    <img height="24">
                    <span class="logo-txt" style="color: white;">SISTEM INFORMASI PARIWISATA KOTA BENGKULU</span>
                </span>
            </div>
        </div>
