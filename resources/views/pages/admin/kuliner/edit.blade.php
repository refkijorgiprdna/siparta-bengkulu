...
@section('title')
Edit Data Kuliner dan Oleh-Oleh | Admin SIPARTA
@endsection
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('kuliner.update', $item->id) }}" method="post">
                        @method('PUT')
                        @csrf
                        <div class="mb-3">
                            <label for="nama">Nama Hotel</label>
                            <input type="text" class="form-control" name="nama" placeholder="Nama Kuliner dan Oleh-Oleh" value="{{ $item->nama }}">
                        </div>
                        <div class="mb-3">
