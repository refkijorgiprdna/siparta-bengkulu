...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('galeri-sub-wisata.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="subwisata_id">Wisata</label>
                        <select name="subwisata_id" required class="form-control">
                            <option value="">Pilih Wisata</option>
                            @foreach ($subwisata as $subwisataa)
                                <option value="{{ $subwisataa->id }}">
                                    {{ $subwisataa->nama }}
                                </option>
                            @endforeach
                        </select>
