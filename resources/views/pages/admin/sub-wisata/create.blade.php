...
@section('title')
Tambah Data Sub Wisata | Admin SIPARTA
@endsection
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Tambah Data Sub Wisata</li>
                    </ol>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('sub-wisata.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama" placeholder="Nama Sub Wisata" value="{{ old('nama') }}">
                        </div>
                        <div class="mb-3">
