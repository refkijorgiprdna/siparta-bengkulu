...
<div class="container-fluid">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('hotel') }}">Kuliner dan Oleh-Oleh</a></li>
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row justify-content-center">
                        @forelse ($item->galerikuliner as $key => $galeri)
    ...
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header mb-0">
                    <h4 class="card-title mb-0 font-size-18" style="color: #000000">Rekomendasi Kuliner dan Oleh-Oleh Kota Bengkulu</h4>
                </div>
                <div class="card-body">
